...
if __name__ == "__main__":
    ...
    SAVE_NUMBER_OFFSET = 256 # Used for adding additional models when some have already been trained.
    ...
    for i in tqdm(range(64)):
        ...
        nonprivate_model = train_model(train_loader, epochs=100, private=False, debug=True) # train non-private model
